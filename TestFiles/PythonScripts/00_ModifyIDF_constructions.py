...
idf.newidfobject(
    ...
    Polygon_Clipping_Algorithm="ConvexWeilerAtherton",
...
# )
print("ZONEINFILTRATION:DESIGNFLOWRATE removed")
...
idf.newidfobject(
    ...
    Name="EXTERIOR GLAZING MATERIAL X COMPLEX",
    Optical_Data_Type="SpectralAverage",
    Thickness=0.006,
    Solar_Transmittance_at_Normal_Incidence=CONFIG["glass_solar_heat_gain_coefficient_X"],
    Front_Side_Solar_Reflectance_at_Normal_Incidence=(1-CONFIG["glass_solar_heat_gain_coefficient_X"])/2,
    Back_Side_Solar_Reflectance_at_Normal_Incidence=(1-CONFIG["glass_solar_heat_gain_coefficient_X"]),
    Visible_Transmittance_at_Normal_Incidence=CONFIG["glass_visible_transmittance_X"],
    Conductivity=(0.006*CONFIG["glass_u_value"])-7e-17
)
...
idf.newidfobject(
    "WINDOWMATERIAL:GAS",
    Name="EXTERIOR GLAZING GAS X COMPLEX",
    Gas_Type="Air",
    Thickness=0.001,
)
...
idf.newidfobject(
    "CONSTRUCTION",
    Name="EXTERIOR WINDOW",
    Outside_Layer="EXTERIOR GLAZING MATERIAL X COMPLEX",
    Layer_2="EXTERIOR GLAZING GAS X COMPLEX",
    Layer_3="EXTERIOR GLAZING MATERIAL X COMPLEX"
)
