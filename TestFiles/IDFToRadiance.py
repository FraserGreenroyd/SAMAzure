...
# Run the LoadModifyIDF.p_y script
#import subprocess
#subprocess.call(["python", "LoadModifyIDF.p_y", idf_config_file])
...
ANNUAL_RECIPE = annual_GridBased(SKY_MATRIX, analysis_grids=ZONE_GRIDS, hb_objects=np.concatenate([EXTERIOR_WALL_SURFACES, INTERIOR_WALL_SURFACES, FLOOR_SURFACES, CEILING_SURFACES, AIRWALL_SURFACES, CONTEXT_SURFACES]).tolist())
